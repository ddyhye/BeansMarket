        ...
        <div class="photo">
            ...
            <div class="photo-tempo">
            	<c:forEach var="item" items="${photoList}">
			        <div class="photo-select-photo">
			            <img src="/photo/${item.new_picname}"/>
			            <i class="fa-solid fa-trash"></i>
			            <input type="hidden" class="tempoPhotoIdx" value="${item.pic_idx}"/>
			        </div>
			    </c:forEach>
    ...
    function salewrite() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                window.location.href='<c:url value="/board/detail.go?idx='+bbsIdx+'"/>';
            },
 ...
 // 사진 추가를 클릭했을 때,
    ...
    $('#photoSave').on('click', function() {
    	...
    	// .tempoBbsIdx가 존재하는지 확인 (즉, 사진을 추가한 것인지?)
   		formData.append('tempoBbsIdx', bbsIdx);
