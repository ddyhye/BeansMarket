	...
	<main>
		...
		<section>
			<div class="content-search">
				<p>검색</p>
				<div class="search-box" data-value="report_hist">
					<input type="text" name="search-val" id="subject-search" placeholder="이메일 혹은 신고 번호를 입력해주세요" />
					<button class="search-btn"><i class="fa-solid fa-magnifying-glass"></i></button>
				</div>
			</div>

            <table id="report-result-box">
                <thead>
                    <tr>
                        <th>신고 번호</th>
                        <th>신고 옵션</th>
...
function historyDraw(list){
	...
	for (item of list) {
		...
		content +=		'<td>'+item.perper_email+'</td>';
